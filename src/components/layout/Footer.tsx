...
const socialLinks = [
  {
    name: "Instagram",
    href: "https://instagram.com/gravilochfinishingugwu",
    icon: (
  ...
  {
    name: "Facebook",
    href: "https://facebook.com/Gravilochfinishingugwu",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor">
    ...
    <footer className={styles.footer}>
        ...
        <div className={styles.brand}>
          <Link href="/" className={styles.logo}>
            ...
            <div className={styles.logoText}>
              <span className={styles.brandName}>GRAVILOCH FINISHINGS <span className={styles.ltd}>LTD</span></span>
              <span className={styles.tagline}>Nikkolor Italian Decorative Paint</span>
            </div>
          </Link>
          ...
          <div className={styles.linksSection}>
            ...
            <ul className={styles.linksList}>
              <li className={styles.contactItem}>
                ...
                <a href="tel:+2348035070793">+234 803 507 0793</a>
              </li>
              <li className={styles.contactItem}>
                <svg
                  viewBox="0 0 24 24"
                ...
                <a href="tel:+2348185242211">+234 818 524 2211</a>
              </li>
              <li className={styles.contactItem}>
                <svg
                  viewBox="0 0 24 24"
                ...
                <a href="mailto:gravilochfinishings@gmail.com">gravilochfinishings@gmail.com</a>
              </li>
              <li className={styles.contactItem}>
                <svg
                  viewBox="0 0 24 24"
                ...
                <span>Port Harcourt • Lagos • Abuja • Calabar • Uyo</span>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div className={styles.bottom}>
        <div className={styles.bottomContent}>
          <p>© {currentYear} GRAVILOCH FINISHINGS <span className={styles.ltdBottom}>LTD</span>. All rights reserved.</p>
