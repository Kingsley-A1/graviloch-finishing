    ...
    <div className={styles.page}>
      <div className={styles.container}>
        ...
        <form onSubmit={handleSubmit} className={styles.form}>
          ...
          <p className={styles.subtitle}>Join the GRAVILOCH admin workspace</p>
          ...
          <div className={styles.infoBox}>
            ...
            <p>
              The registration code is shared among all admins. Use this same
              code to login after registration.
            </p>
          </div>
